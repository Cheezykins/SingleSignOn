                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST"
                            ...
                            <div class="form-group{{ $errors->has('enable_ssl_validation') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    Yes <input type="radio" value="1" name="enable_ssl_validation" @if($service->enable_ssl_validation)checked @endif>
                                    No <input type="radio" value="0" name="enable_ssl_validation" @if(!$service->enable_ssl_validation)checked @endif>
